...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Android.DeskClock.VerticalViewPager+VerticalPageTransformer, Com.Android.DeskClock, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", VerticalViewPager_VerticalPageTransformer.class, __md_methods);
	}
	...
	public VerticalViewPager_VerticalPageTransformer ()
	{
		...
		if (getClass () == VerticalViewPager_VerticalPageTransformer.class)
			mono.android.TypeManager.Activate ("Com.Android.DeskClock.VerticalViewPager+VerticalPageTransformer, Com.Android.DeskClock, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
